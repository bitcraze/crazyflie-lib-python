...
# for hip extension
max_ROM_x = 0.00   # change this variable according to the selected movement
ori_pos_x = 0.46    # original leg's sensor position in x-axis
...
# for hip abduction
max_ROM_y = -0.50   # change this variable according to the selected movement
ori_pos_y = 0.00    # original leg's sensor position in y-axis
