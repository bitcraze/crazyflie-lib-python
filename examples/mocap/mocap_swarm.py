...
to multiple Crazyflies, using the motioncapture library. The swarm takes off and
flies a synchronous square shape before landing. The trajectories are relative to
the starting positions and the Crazyflies can be at any position on the floor when
the script is started. The script uses the high level commander and the Swarm class.
