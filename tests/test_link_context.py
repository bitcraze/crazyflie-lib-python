...
class TestLinkContextValidation:
    ...
    def test_scan_address_exact_length_validates(self) -> None:
        ...
        try:
            context.scan(address=valid_address)
    ...
    def test_scan_default_address(self) -> None:
        ...
        try:
            context.scan()  # No address = use default
        except Exception as e:
